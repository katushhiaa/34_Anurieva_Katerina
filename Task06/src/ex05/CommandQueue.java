...
/**
 * Creates a thread handler that executes objects with the Command interface; sample
 * Worker Thread
 *
 * @seeCommand
 */
public class CommandQueue implements Queue {
    ...
    /**
     * Serves the task queue; template Worker Thread
     *
     * @see Runnable
     */
    private class Worker implements Runnable {
        ...
        /**
         * Retrieves tasks ready for execution from the queue; template Worker Thread
         */
        public void run() {
            while (!shutdown) {
                Command r = take();
