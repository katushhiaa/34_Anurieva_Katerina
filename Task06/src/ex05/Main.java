...
/**
 * Calculation and display of results; contains the implementation of the static method
 *main()
 *
 * @see Main#main
 */
public class Main {
        ...
        * objects {@linkplain ex01.Item2d}; 15 initialized with Factory
        *Method
        */
	private final View view = new ViewableResult().getView();
        /**
        * Class object {@linkplain Menu}; macro command (Command template)
        */
