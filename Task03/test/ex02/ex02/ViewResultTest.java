...
public class ViewResultTest {
    ...
    public void testCalculateOnesCount() {
        ...
        int expected1 = Integer.bitCount((int) viewResult.calculateOnesCount(viewResult.getItems().get(0).getArg1(), viewResult.getItems().get(0).getArg2(), viewResult.getItems().get(0).getArg3(), viewResult.getItems().get(0).getArg4()));
        int expected2 = Integer.bitCount((int) viewResult.calculateOnesCount(viewResult.getItems().get(1).getArg1(), viewResult.getItems().get(1).getArg2(), viewResult.getItems().get(1).getArg3(), viewResult.getItems().get(1).getArg4()));
