...
public class Item2d implements Serializable {
    ...
    public double setOnesOut(double OneOut) {
        return this.OnesOut = (int) OneOut;
    }
    ...
    public int hashCode() {
        int hash = 7;
        hash = 89 * hash + (int) (Double.doubleToLongBits(this.arg1) ^ (Double.doubleToLongBits(this.arg1) >>> 32));
        hash = 89 * hash + (int) (Double.doubleToLongBits(this.arg2) ^ (Double.doubleToLongBits(this.arg2) >>> 32));
        hash = 89 * hash + (int) (Double.doubleToLongBits(this.arg3) ^ (Double.doubleToLongBits(this.arg3) >>> 32));
        hash = 89 * hash + (int) (Double.doubleToLongBits(this.arg4) ^ (Double.doubleToLongBits(this.arg4) >>> 32));
        hash = 89 * hash + (int) (Double.doubleToLongBits(this.SinAverage) ^ (Double.doubleToLongBits(this.SinAverage) >>> 32));
        hash = 89 * hash + this.OnesOut;
        return hash;
    }
}
